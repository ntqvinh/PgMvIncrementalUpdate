...
extern struct s_SelectingQuery		*_MVIAUTG_SelectingQuery;
extern struct s_Table				*_MVIAUTG_Tables							[MAX_N_TABLES];
extern struct s_Column				*_MVIAUTG_SelectedColumn					[MAX_N_COLS];
extern int							_MVIAUTG_NSelectedCol;
extern char							*_MVIAUTG_OutConditions						[MAX_N_TABLES][MAX_N_ELEMENTS];	
extern int							_MVIAUTG_OutConditionsElementNum			[MAX_N_TABLES];		
extern char							*_MVIAUTG_InConditions						[MAX_N_TABLES][MAX_N_ELEMENTS];	
extern int							_MVIAUTG_InConditionsElementNum				[MAX_N_TABLES];		
extern char							*_MVIAUTG_BinConditions						[MAX_N_TABLES][MAX_N_ELEMENTS];	
extern int							_MVIAUTG_BinConditionsElementNum			[MAX_N_TABLES];		
