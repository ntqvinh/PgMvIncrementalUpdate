...
extern struct s_Table				*PREPARED_STATEMENT_table[MAX_N_TABLES];
extern struct s_Column				*PREPARED_STATEMENT_selectedColumn[MAX_N_COLS];
extern int							PREPARED_STATEMENT_nSelectedCol;
extern struct s_Column				*PREPARED_STATEMENT_primaryColumn[MAX_N_COLS];
extern int							PREPARED_STATEMENT_nPkCol;
extern char							*PREPARED_STATEMENT_outConditions[MAX_N_TABLES][MAX_N_ELEMENTS];
extern int							PREPARED_STATEMENT_outConditionsElementNum[MAX_N_TABLES];
extern char							*PREPARED_STATEMENT_inConditions[MAX_N_TABLES][MAX_N_ELEMENTS];
extern char							*PREPARED_STATEMENT_inConditionsOld[MAX_N_TABLES][MAX_N_ELEMENTS];
extern char							*PREPARED_STATEMENT_inConditionsNew[MAX_N_TABLES][MAX_N_ELEMENTS];
extern int							PREPARED_STATEMENT_inConditionsElementNum[MAX_N_TABLES];
extern char							*PREPARED_STATEMENT_binConditions[MAX_N_TABLES][MAX_N_ELEMENTS];
extern int							PREPARED_STATEMENT_binConditionsElementNum[MAX_N_TABLES];
extern char							*PREPARED_STATEMENT_firstCheckingCondition[MAX_N_TABLES];
extern char							*PREPARED_STATEMENT_firstCheckingConditionOld[MAX_N_TABLES];
extern char							*PREPARED_STATEMENT_firstCheckingConditionNew[MAX_N_TABLES];
